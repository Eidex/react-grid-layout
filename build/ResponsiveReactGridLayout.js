...
var ResponsiveReactGridLayout = (function(_React$Component) {
  ...
  ResponsiveReactGridLayout.getDerivedStateFromProps = function getDerivedStateFromProps(
    ...
    if (
      nextProps.width != prevState.prevProps.width ||
      nextProps.breakpoint !== prevState.prevProps.breakpoint ||
      !(0, _lodash2.default)(
        nextProps.breakpoints,
        prevState.prevProps.breakpoints
      ) ||
      !(0, _lodash2.default)(nextProps.cols, prevState.prevProps.cols)
    ) {
      /**
      ...
      if (
        ...
        prevState.prevProps.breakpoints !== _breakpoints ||
        prevState.prevProps.cols !== _cols
      ) {
        // Preserve the current layout if the current breakpoint is not present in the next layouts.
        if (!(lastBreakpoint in _layouts))
          _layouts[lastBreakpoint] = (0, _utils.cloneLayout)(
            prevState.prevProps.layout
          );

        // Find or generate a new layout.
        _layout = (0, _responsiveUtils.findOrGenerateResponsiveLayout)(
          _layouts,
          _breakpoints,
          newBreakpoint,
          lastBreakpoint,
      ...
      prevState.prevProps.onWidthChange(
        nextProps.width,
        nextProps.margin,
        newCols,
      ...
      !(0, _lodash2.default)(nextProps.layouts, prevState.prevProps.layouts)
    ) {
