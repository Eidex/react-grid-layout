!(function(t, e) {
  ...
  return (function(t) {
    ...
    function(t, e, r) {
      "use strict";
      (e.__esModule = !0),
        (e.createDragApiRef = e.noop = e.trampoline = void 0);
      var n =
          Object.assign ||
          function(t) {
      ...
      (e.bottom = c),
        ...
        (e.childrenEqual = function(t, e) {
          return (0, a.default)(
            i.default.Children.map(t, function(t) {
              return t.key;
            }),
            i.default.Children.map(e, function(t) {
              return t.key;
            })
          );
        }),
        ...
        (e.correctBounds = v),
        (e.getLayoutItem = b),
        (e.getFirstCollision = w),
        (e.getAllCollisions = x),
        (e.getStatics = S),
        (e.moveElement = _),
        (e.moveElementAwayFromCollision = R),
        (e.perc = function(t) {
          return 100 * t + "%";
        }),
          ...
          return (
            i.default.Children.forEach(e, function(e, r) {
              ...
              if (o) a[r] = p(o);
                ...
                i
                  ? (u || D([i], "ReactGridLayout.children"),
                    (a[r] = p(n({}, i, { i: e.key }))))
                  : (a[r] = p({ w: 1, h: 1, x: 0, y: c(a), i: String(e.key) }));
              }
            }),
            (a = d((a = v(a, { cols: r })), o, r))
          );
        }),
        (e.validateLayout = D),
      ...
      function d(t, e, r) {
        for (
          var n = S(t), o = O(t, e), a = Array(t.length), i = 0, s = o.length;
          i < s;
          i++
        ) {
          var u = p(o[i]);
          u.static || ((u = m(n, u, e, r, o)), n.push(u)),
            (a[t.indexOf(o[i])] = u),
            (u.moved = !1);
        }
        return a;
        ...
        t: for (
          ...
          switch (u) {
            ...
            case "break":
              break t;
            default:
              if ("object" === (void 0 === u ? "undefined" : o(u))) return u.v;
          }
        }
        e[n] = r;
      }
      var g = (e.trampoline = function(t) {
        return function() {
          for (
            var e = t.apply(void 0, arguments), r = 0;
            "function" == typeof e && ((e = e()), !(r > 100));
      ...
      function m(t, e, r, n, o) {
        ...
        for (var i = void 0, s = g(y); (i = w(t, e)); )
          a ? s(o, e, i.x + i.w, "x") : s(o, e, i.y + i.h, "y"),
      ...
      function w(t, e) {
        for (var r = 0, n = t.length; r < n; r++) if (f(t[r], e)) return t[r];
      }
      function x(t, e) {
      ...
      function _(t, e, r, n, o, a, i, s) {
        ...
        ("vertical" === i && "number" == typeof n
          ? l >= n
          : "horizontal" === i && "number" == typeof r && u >= r) &&
          (c = c.reverse());
        var p = x(c, e);
        if (a && p.length)
          return (
        ...
        for (var f = 0, d = p.length; f < d; f++) {
          ...
          P(
            ...
            h.moved ||
              (t = h.static ? R(t, h, e, o, i, s) : R(t, e, h, o, i, s));
        }
        return t;
      }
        ...
        if (n) {
          ...
          if (!w(t, u))
            return (
              ...
              _(t, r, i ? u.x : void 0, s ? u.y : void 0, n, !1, o, a)
            );
        }
        return _(t, r, i ? r.x + 1 : void 0, s ? r.y + 1 : void 0, n, !1, o, a);
      }
      function O(t, e) {
        return "horizontal" === e ? z(t) : j(t);
      }
      function j(t) {
      ...
      function D(t) {
        ...
        for (var n = 0, o = t.length; n < o; n++) {
          ...
          if (a.i && "string" != typeof a.i)
            throw new Error(
              "ReactGridLayout: " + e + "[" + n + "].i must be a string!"
            );
          if (void 0 !== a.static && "boolean" != typeof a.static)
            throw new Error(
              "ReactGridLayout: " + e + "[" + n + "].static must be a boolean!"
            );
        }
      }
      function P() {
    ...
    function(t, e, r) {
      (function(t, r) {
        ...
        (C["[object Float32Array]"] = C["[object Float64Array]"] = C[
          ...
          (C[u] = C[l] = C[j] = C[p] = C[z] = C[f] = C[d] = C[h] = C[g] = C[
            m
        ...
        var k = "object" == typeof t && t && t.Object === Object && t,
          ...
          M = e && !e.nodeType && e,
          L = M && "object" == typeof r && r && !r.nodeType && r,
          N = L && L.exports === M,
          W = N && k.process,
          A = (function() {
            try {
          ...
          return (
            ...
            (null == t || null == e || (!Jt(t) && !Jt(e))
              ...
              : (function(t, e, r, n, o, s) {
                  ...
                  if (!(r & a)) {
                    var P = w && K.call(t, "__wrapped__"),
                      C = O && K.call(e, "__wrapped__");
                    if (P || C) {
                      var k = P ? t.value() : t,
                        E = C ? e.value() : e;
                      return s || (s = new zt()), o(k, E, r, n, s);
                    }
                  }
                  if (!D) return !1;
                  return (
                    ...
                    (function(t, e, r, n, o, i) {
                      ...
                      for (var y = s; ++p < l; ) {
                        ...
                        var g = t[f],
                          m = e[f];
                        if (n)
                          var v = s ? n(m, g, f, e, t, i) : n(g, m, f, t, e, i);
        ...
        function Mt(t) {
          if (
            ((r = (e = t) && e.constructor),
            (n = ("function" == typeof r && r.prototype) || V),
            e !== n)
          )
            return lt(t);
          var e,
        ...
        function Lt(t, e, r, n, o, s) {
          ...
          for (s.set(t, e), s.set(e, t); ++f < l; ) {
            var y = t[f],
              g = e[f];
            if (n) var m = u ? n(g, y, f, e, t, s) : n(y, g, f, t, e, s);
            if (void 0 !== m) {
              if (m) continue;
              d = !1;
              break;
            ...
            if (h) {
              if (
                !I(e, function(t, e) {
                  if (((a = e), !h.has(a) && (y === t || o(y, t, r, n, s))))
                    return h.push(e);
                  var a;
                })
              ) {
        ...
        (_t.prototype.clear = function() {
          ...
          (Rt.prototype.delete = function(t) {
            ...
            return !(
              r < 0 ||
              (r == e.length - 1 ? e.pop() : at.call(e, r, 1), --this.size, 0)
            );
          }),
        ...
        var Kt = H
          ...
          : function(t) {
              return Jt(t) && Vt(t.length) && !!C[Ct(t)];
            };
        function Qt(t) {
    ...
    function(t, e, r) {
      ...
      var f = (function(t) {
        ...
        return (
            ...
            (this.props.dragApiRef.value = {
              dragIn: function(r) {
                var n = r.i,
                  ...
                  s = r.event,
                  u = r.position;
                e = { i: n, w: o, h: a, node: i };
                var c = t.state.layout,
                  p = t.props,
                  f = p.margin,
                  d = p.containerPadding,
                  h = (0, l.calcXY)(u.top, u.left, {
                ...
                if (t.state.activeDrag)
                  t.onDrag(n, y, g, { e: s, node: i, newPosition: u });
                else {
                  var m = { i: n, w: o, h: a, x: y, y: g };
                  t.setState({
                    oldDragItem: m,
                    oldLayout: c,
              ...
              stop: function(r) {
                ...
                if (e) {
                  var a = e,
                    ...
                    y = h.x,
                    g = h.y;
                  t.onDragStop(i, y, g, { e: n, node: c, newPosition: o }),
                    (e = null);
                }
              }
            }),
          ...
          (e.getDerivedStateFromProps = function(t, e) {
            var r = void 0;
            (0, i.default)(t.layout, e.prevProps.layout) &&
            t.compactType === e.prevProps.compactType
              ? (0, u.childrenEqual)(e.prevProps.children, t.children) ||
                (r = e.layout)
              : (r = t.layout);
            var o;
            if (r) {
              var a = (0, u.synchronizeLayoutWithChildren)(
                  r,
                  t.children,
                  t.cols,
                  ((o = t) || (o = e.prevProps),
                  !1 === o.verticalCompact ? null : o.compactType)
                ),
                s = e.layout;
              return (
                s || (s = e.layout),
                (0, i.default)(s, a) || e.prevProps.onLayoutChange(a),
                { layout: a, prevProps: n({}, t) }
              );
            }
            return null;
          }),
          ...
          (e.prototype.processGridItem = function(t) {
            if (t && t.key) {
              ...
              var r = this.props,
                ...
                a = r.cols,
                i = r.margin,
                s = r.containerPadding,
                l = r.rowHeight,
                p = r.maxRows,
                f = r.isDraggable,
                d = r.isResizable,
                h = r.useCSSTransforms,
                y = r.overridePosition,
                g = r.draggableCancel,
                m = r.draggableHandle,
                ...
                w = Boolean(
                  !e.static && d && (e.isResizable || null == e.isResizable)
                );
              return o.default.createElement(
                c.default,
                {
          ...
          (e.prototype.render = function() {
            var t = this,
              ...
              r = e.className,
              a = e.style,
              i = (0, s.default)("react-grid-layout", r),
              u = n({ height: this.containerHeight() }, a);
            return o.default.createElement(
              "div",
              { className: i, style: u },
      ...
      (f.displayName = "ReactGridLayout"),
        (f.propTypes = {
          ...
          overridePosition: a.default.bool,
...
*/
    ...
    function(t, e, r) {
      t.exports = (function(t, e) {
        ...
        var s = function(t, e, r, n, o, a, s, u) {
            if ((i(e), !t)) {
              var l;
              if (void 0 === e)
                l = new Error(
            ...
            var r = "function" == typeof Symbol && Symbol.iterator,
              ...
              i = {
                ...
                arrayOf: function(t) {
                  return c(function(e, r, n, o, a) {
                    ...
                    for (var u = 0; u < i.length; u++) {
                      var c = t(i, u, n, o, a + "[" + u + "]", d);
                      if (c instanceof Error) return c;
                    }
                    return null;
                  });
                },
                element: c(function(e, r, n, o, a) {
                  var i = e[r];
                  if (!t(i)) {
                    var s = y(i);
                    return new l(
                ...
                instanceOf: function(t) {
                  return c(function(e, r, n, a, i) {
                    if (!(e[r] instanceof t)) {
                      var s = t.name || o,
                        u =
                          (c = e[r]).constructor && c.constructor.name
                            ? c.constructor.name
                            : o;
                      return new l(
                        "Invalid " +
                ...
                oneOfType: function(t) {
                  ...
                  return c(function(e, r, n, o, a) {
                    for (var i = 0; i < t.length; i++) {
                      var s = t[i];
                      if (null == s(e, r, n, o, a, d)) return null;
                    }
                    return new l(
                      "Invalid " + o + " `" + a + "` supplied to `" + n + "`."
                    );
                  });
                },
                shape: function(t) {
	...
	*/
            !(function() {
              ...
              function r() {
                for (var t = [], n = 0; n < arguments.length; n++) {
                  ...
                  if (o) {
                    ...
                    else if (Array.isArray(o)) t.push(r.apply(null, o));
                    else if ("object" === a)
              ...
              t.exports ? (t.exports = r) : (window.classNames = r);
            })();
          });
        function S(t, e) {
        ...
        var P = (function() {
            ...
            if (t in e) return "";
            for (var r = 0; r < z.length; r++) if (D(t, z[r]) in e) return z[r];
            return "";
          })(),
          C = function(t, e) {
            if (!(t instanceof e))
        ...
        function q(t) {
          ...
          return (e += O(r.borderTopWidth)), (e += O(r.borderBottomWidth));
        }
        function Y(t) {
          var e = t.clientWidth,
            r = t.ownerDocument.defaultView.getComputedStyle(t);
          return (e += O(r.borderLeftWidth)), (e += O(r.borderRightWidth));
        }
        function X(t) {
          var e = t.clientHeight,
            r = t.ownerDocument.defaultView.getComputedStyle(t);
          return (e -= O(r.paddingTop)), (e -= O(r.paddingBottom));
        }
        function F(t) {
          var e = t.clientWidth,
            r = t.ownerDocument.defaultView.getComputedStyle(t);
          return (e -= O(r.paddingLeft)), (e -= O(r.paddingRight));
        }
        function U(t) {
          if (t) {
            var e,
              r,
              n = t.getElementById("react-draggable-style-el");
            n ||
              (((n = t.createElement("style")).type = "text/css"),
              (n.id = "react-draggable-style-el"),
              (n.innerHTML =
              ...
              t.body &&
                ((e = t.body),
                (r = "react-draggable-transparent-selection"),
                e.classList
                  ? e.classList.add(r)
                  : e.className.match(
                      new RegExp("(?:^|\\s)" + r + "(?!\\S)")
        ...
        function K(t, e, r) {
          ...
          return (function(t, e) {
            var r =
              ...
              n = t.clientX + e.scrollLeft - r.left,
              o = t.clientY + e.scrollTop - r.top;
            return { x: n, y: o };
          })(n || t, a);
        }
        function Q(t, e, r) {
            ...
            function n() {
              ...
              return (
                ...
                (o.handleDragStart = function(e) {
                  ...
                  if (
                    !(
                      ...
                      (o.props.handle && !H(e.target, o.props.handle, r)) ||
                      (o.props.cancel && H(e.target, o.props.cancel, r))
                    )
                  ) {
                    var a = (function(t) {
                    ...
                    if (null != i) {
                      ...
                      !1 !== c &&
                        (o.props.enableUserSelectHack && U(n),
                        o.setState({ dragging: !0, lastX: s, lastY: u }),
                        I(n, rt.move, o.handleDrag),
                        I(n, rt.stop, o.handleDragStop));
                    }
                  }
                }),
                (o.handleDrag = function(t) {
                  ...
                  if (null != e) {
                    ...
                    if (Array.isArray(o.props.grid)) {
                      ...
                      (r = o.state.lastX + a), (n = o.state.lastY + i);
                    }
                    var l = Q(o, r, n),
                      c = o.props.onDrag(t, l);
                    if (!1 !== c) o.setState({ lastX: r, lastY: n });
                    else
                      try {
                ...
                (o.handleDragStop = function(e) {
                  if (o.state.dragging) {
                    var r = K(e, o.state.touchIdentifier, o);
                    if (null != r) {
                      var n = r.x,
                        a = r.y,
                        i = Q(o, n, a),
                ...
                (o.onMouseDown = function(t) {
                  return (rt = et.mouse), o.handleDragStart(t);
                }),
                (o.onMouseUp = function(t) {
                  return (rt = et.mouse), o.handleDragStop(t);
                }),
                (o.onTouchStart = function(t) {
                  return (rt = et.touch), o.handleDragStart(t);
                }),
                (o.onTouchEnd = function(t) {
                  return (rt = et.touch), o.handleDragStop(t);
                }),
                L(o, r)
              );
            }
              ...
              (e.onDrag = function(t, r) {
                ...
                if (e.props.bounds) {
                  ...
                  var s = (function(t, e, r) {
                        ...
                        if (
                          !(
                            (s =
                              "parent" === n
                                ? o.parentNode
                                : a.querySelector(n)) instanceof i.HTMLElement
                          )
                        )
                          throw new Error(
                            'Bounds selector "' +
                      ...
                      return (
                        R(n.right) && (e = Math.min(e, n.right)),
                        R(n.bottom) && (r = Math.min(r, n.bottom)),
                        R(n.left) && (e = Math.max(e, n.left)),
                        R(n.top) && (r = Math.max(r, n.top)),
                        [e, r]
                      );
                    })(e, o.x, o.y),
                    u = N(s, 2),
                ...
                var p = e.props.onDrag(t, n);
                if (!1 === p) return !1;
                e.setState(o);
              }),
              (e.onDragStop = function(t, r) {
                if (!e.state.dragging) return !1;
                var n = e.props.onStop(t, Z(e, r));
                if (!1 === n) return !1;
                ...
                value: function() {
                  ...
                  var p = this.props,
                    ...
                    g = x(
                      y.props.className || "",
                      f,
                      (E((t = {}), d, this.state.dragging),
                      E(t, h, this.state.dragged),
                      t)
                    );
        ...
        return (
          ...
          (ot.defaultProps = T({}, nt.defaultProps, {
            axis: "both",
            bounds: !1,
    ...
    function(t, e, r) {
      ...
      (e.__esModule = !0),
        ...
        (e.findOrGenerateResponsiveLayout = function(t, e, r, a, i, s) {
          ...
          return (
            (u = (0, n.cloneLayout)(u || [])),
            (0, n.compact)((0, n.correctBounds)(u, { cols: i }), s, i)
          );
        }),
        (e.sortBreakpoints = o);
      var n = r(2);
    ...
    function(t, e, r) {
      ...
      (t.exports = r(4).default),
        (t.exports.createDragApiRef = n.createDragApiRef),
        (t.exports.utils = n),
        (t.exports.Responsive = r(19).default),
        (t.exports.Responsive.utils = r(9)),
        (t.exports.WidthProvider = r(20).default);
    },
    function(t, e) {
      var r;
      r = (function() {
    ...
    function(t, e, r) {
      ...
      var h = (function(t) {
        function e() {
          ...
          for (var o = arguments.length, a = Array(o), i = 0; i < o; i++)
            a[i] = arguments[i];
          return (
            (r = n = p(this, t.call.apply(t, [this].concat(a)))),
            (n.state = { resizing: null, dragging: null, className: "" }),
            p(n, r)
          );
        }
        return (
            ...
            var a = this.props,
              ...
              c = {
                ...
                width:
                  r === 1 / 0
                    ? r
                    : Math.round(l * r + Math.max(0, r - 1) * i[0]),
                height:
                  n === 1 / 0
                    ? n
                    : Math.round(u * n + Math.max(0, n - 1) * i[1])
              };
            return (
              o &&
                o.resizing &&
          ...
          (e.prototype.createStyle = function(t) {
            ...
            return (
              e.overridePosition
                ? (a = {})
                : o
                ? (a = (0, u.setTransform)(t))
                : ((a = (0, u.setTopLeft)(t)),
                  r &&
                    ((a.left = (0, u.perc)(t.left / n)),
                    (a.width = (0, u.perc)(t.width / n)))),
              a
            );
          }),
          ...
          (e.prototype.mixinResizable = function(t, e) {
            var r = this.props,
              ...
              l = r.maxW,
              c = r.maxH,
              p = this.calcPosition(0, 0, n - a, 0).width,
          ...
          (e.prototype.onDragHandler = function(t) {
            ...
            return function(r, n) {
              ...
              if (s) {
                ...
                var f = d(u.top, u.left, e.props),
                  h = f.x,
                  y = f.y;
                return s.call(e, e.props.i, h, y, {
                  e: r,
                  node: o,
                  newPosition: u
                });
            ...
            return function(r, n) {
              ...
              if (i) {
                ...
                (g = Math.min(g, u - l)),
                  ...
                  i.call(e, c, g, m, { e: r, node: o, size: a });
              }
            };
          }),
          (e.prototype.render = function() {
            var t = this.props,
              ...
              p = this.calcPosition(e, r, a, i, this.state),
              f = o.default.Children.only(this.props.children),
              d = o.default.cloneElement(f, {
            ...
            return (
              u && (d = this.mixinResizable(d, p)),
              s && (d = this.mixinDraggable(d)),
              d
            );
          }),
          e
      ...
      (h.propTypes = {
        ...
        overridePosition: a.default.bool.isRequired,
        className: a.default.string,
    ...
    function(t, e, r) {
      ...
      (t.exports = function() {
        ...
        (t.exports.Resizable = r(8).default),
        (t.exports.ResizableBox = r(18).default);
    },
    function(t, e, r) {
      "use strict";
      var n,
      ...
      var l = (function(t) {
        function e() {
          ...
          return (
            ...
            (n.state = { width: n.props.width, height: n.props.height }),
              ...
              n.props.onResize
                ? (t.persist && t.persist(),
                  n.setState(r, function() {
                    return n.props.onResize && n.props.onResize(t, e);
                  }))
                : n.setState(r);
            }),
            u(n, r)
        ...
        d = (function(t) {
          function e() {
            ...
            for (var a = arguments.length, i = Array(a), s = 0; s < a; s++)
              i[s] = arguments[s];
            return (
              (r = o = p(this, t.call.apply(t, [this].concat(i)))),
          ...
          return (
            ...
            (e.prototype.generateInitialState = function() {
              var t = this.props,
                ...
                o = t.layouts,
                a = t.cols,
                i = (0, u.getBreakpointFromWidth)(r, e),
                s = (0, u.getColsFromBreakpoint)(i, a),
                l =
                  !1 === this.props.verticalCompact
                    ? null
                    : this.props.compactType;
              return {
                layout: (0, u.findOrGenerateResponsiveLayout)(o, r, i, i, s, l),
                breakpoint: i,
                cols: s,
                prevProps: n({}, this.props)
              };
            ...
            (e.getDerivedStateFromProps = function(t, e) {
              if (
                t.width == e.prevProps.width &&
                t.breakpoint === e.prevProps.breakpoint &&
                (0, i.default)(t.breakpoints, e.prevProps.breakpoints) &&
                (0, i.default)(t.cols, e.prevProps.cols)
              ) {
                if (!(0, i.default)(t.layouts, e.prevProps.layouts)) {
                  var r = e.breakpoint,
                    o = e.cols;
                  return {
                ...
                var a = t.breakpoints,
                  ...
                  d = e.breakpoint,
                  h = (0, u.getColsFromBreakpoint)(f, l),
                  y = !1,
                  g = void 0;
                if (
                  ((d === f &&
                    e.prevProps.breakpoints === a &&
                    e.prevProps.cols === l) ||
                    (d in c || (c[d] = (0, s.cloneLayout)(e.prevProps.layout)),
                    (g = (0, u.findOrGenerateResponsiveLayout)(
                      c,
                      a,
                      f,
                      d,
                    ...
                    (g = (0, s.synchronizeLayoutWithChildren)(
                      g,
                      t.children,
                      h,
                      p
                    ...
                    (c[f] = g),
                    e.prevProps.onLayoutChange(g, c),
                    e.prevProps.onBreakpointChange(f, h),
                    (y = !0)),
                  e.prevProps.onWidthChange(
                    t.width,
                    t.margin,
                    h,
                    t.containerPadding
          ...
          (r = e = (function(e) {
            function r() {
              ...
              for (var o = arguments.length, a = Array(o), s = 0; s < o; s++)
                a[s] = arguments[s];
              return (
                (n = u(this, e.call.apply(e, [this].concat(a)))),
                (t = n),
                (n.state = { width: 1280 }),
                (n.mounted = !1),
                (n.onWindowResize = function() {
                  if (n.mounted) {
                    var t = i.default.findDOMNode(n);
                    t instanceof HTMLElement &&
                      n.setState({ width: t.offsetWidth });
                  }
                }),
                u(n, t)
              );
            ...
            return (
              ...
              (r.prototype.render = function() {
                ...
                return r && !this.mounted
                  ...
                  : o.default.createElement(t, n({}, a, this.state));
              }),
              r
            );
          })(o.default.Component)),
