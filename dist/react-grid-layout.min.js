!(function(t, e) {
  ...
  return (function(t) {
    ...
    function(t, e, r) {
              ...
              if (o) i[r] = c(o);
                ...
                a
                  ? (s || j([a], "ReactGridLayout.children"),
                    (i[r] = c(n({}, a, { i: e.key }))))
                  : (i[r] = c({ w: 1, h: 1, x: 0, y: l(i), i: String(e.key) }));
              }
            }),
            (i = f((i = g(i, { cols: r })), o, r))
          );
        }),
        (e.validateLayout = j),
      ...
      function f(t, e, r) {
        for (
          var n = w(t), o = _(t, e), a = Array(t.length), i = 0, s = o.length;
          i < s;
          i++
        ) {
          var u = c(o[i]);
          u.static || ((u = y(n, u, e, r, o)), n.push(u)),
            (a[t.indexOf(o[i])] = u),
            (u.moved = !1);
        }
        return a;
      ...
      function g(t, e) {
        for (var r = w(t), n = 0, o = t.length; n < o; n++) {
          var a = t[n];
          if (
      ...
      function v(t, e) {
        for (var r = 0, n = t.length; r < n; r++) if (p(t[r], e)) return t[r];
      }
      function b(t, e) {
        ...
        if (n) {
          ...
          if (!v(t, u))
            return (
              ...
              x(t, r, i ? u.x : void 0, s ? u.y : void 0, n, !1, o, a)
            );
        }
        return x(t, r, i ? r.x + 1 : void 0, s ? r.y + 1 : void 0, n, !1, o, a);
      }
      function _(t, e) {
          ...
          (e.prototype.createStyle = function(t) {
            ...
            return (
              e.useCSSTransforms
                ...
                : ((o = (0, u.setTopLeft)(t)),
                  r &&
                    ((o.left = (0, u.perc)(t.left / n)),
                    (o.width = (0, u.perc)(t.width / n)))),
              o
            );
          }),
