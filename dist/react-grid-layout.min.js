  ...
  return (function(t) {
    ...
    function(t, e, n) {
      ...
      (e.bottom = l),
        ...
        (e.correctBounds = m),
        (e.getLayoutItem = v),
        (e.getFirstCollision = b),
        (e.getAllCollisions = w),
        (e.getStatics = x),
        (e.moveElement = S),
        (e.moveElementAwayFromCollision = _),
        (e.perc = function(t) {
          return 100 * t + "%";
        }),
      ...
      function f(t, e, n) {
        for (
          var r = x(t), o = R(t, e), a = Array(t.length), i = 0, s = o.length;
          i < s;
          i++
        ) {
          var u = c(o[i]);
          u.static || ((u = g(r, u, e, n, o)), r.push(u)),
            (a[t.indexOf(o[i])] = u),
            (u.moved = !1);
        }
        return a;
      ...
      var y = (e.trampoline = function(t) {
        return function() {
          for (var e = t.apply(void 0, arguments); "function" == typeof e; )
            e = e();
        };
      });
      function g(t, e, n, r, o) {
        var a = "horizontal" === n;
        if ("vertical" === n)
          for (e.y = Math.min(l(t), e.y); e.y > 0 && !b(t, e); ) e.y--;
        else if (a)
          for (e.y = Math.min(l(t), e.y); e.x > 0 && !b(t, e); ) e.x--;
        for (var i = void 0, s = y(h); (i = b(t, e)); )
          a ? s(o, e, i.x + i.w, "x") : s(o, e, i.y + i.h, "y"),
            a && e.x + e.w > r && ((e.x = r - e.w), e.y++);
        return e;
      }
      function m(t, e) {
        for (var n = x(t), r = 0, o = t.length; r < o; r++) {
          var a = t[r];
          if (
      ...
      function S(t, e, n, r, o, a, i, s) {
        ...
        for (var f = 0, d = p.length; f < d; f++) {
          ...
          D(
            ...
            h.moved ||
              (t = h.static ? _(t, h, e, o, i, s) : _(t, e, h, o, i, s));
        }
        return t;
      }
        ...
        if (r) {
          ...
          if (!b(t, u))
            return (
              ...
              S(t, n, i ? u.x : void 0, s ? u.y : void 0, r, !1, o, a)
            );
        }
        return S(t, n, i ? n.x + 1 : void 0, s ? n.y + 1 : void 0, r, !1, o, a);
      }
      function R(t, e) {
        return "horizontal" === e ? j(t) : O(t);
      }
      function O(t) {
          ...
          return (
            ...
            (e.prototype.generateInitialState = function() {
              var t = this.props,
                ...
                o = t.layouts,
                a = t.cols,
                i = (0, u.getBreakpointFromWidth)(n, e),
              ...
              return {
                layout: (0, u.findOrGenerateResponsiveLayout)(o, n, i, i, s, l),
                breakpoint: i,
                cols: s,
                prevProps: r({}, this.props)
              };
